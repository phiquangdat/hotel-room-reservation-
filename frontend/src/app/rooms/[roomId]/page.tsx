...
import { Bed, Wifi, Tv, Coffee, Users, MapPin, DollarSign } from "lucide-react";

// Define the type for the room
interface Room {
    id: string;
    hotelName: string;
    roomType: string;
...
export default function RoomDetailsPage() {
    ...
    useEffect(() => {
        const mockRoom: Room = {
            ...
            description:
                "Spacious deluxe room featuring a king-size bed, private balcony with sea view, and a modern bathroom. Perfect for a relaxing stay in the heart of Vaasa.",
            pricePerNight: 179,
            capacity: 2,
